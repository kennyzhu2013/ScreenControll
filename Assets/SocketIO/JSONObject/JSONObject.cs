...
public class JSONObject {
	...
	public enum Type { NULL, STRING, NUMBER, INTGER, OBJECT, ARRAY, BOOL, BAKED }
	...
	public bool bClassNameExist = true;
		...
		if(!string.IsNullOrEmpty(str)) {
			...
			if(str.Length > 0) {
				if(string.Compare(str, "true", true) == 0) {
					 ...
					 * value - string	- "string"
					 * arraylist - [{"field1":value,"field2":value},{"field1":value,"field2":value}]
					 *		 - number	- 0.0
					 *		 - bool		- true -or- false
					 *		 - null		- null
					 */
					...
					//获取classname...
					if ( type == Type.OBJECT && bClassNameExist ) {
						++offset;
