...
//just for windows style...
using Common;
using System;

/// <summary>
/// SC windows manager for windows switch...
/// </summary>
public class SCWindowsManager : SingletonT<SCWindowsManager>{
	...
	private bool FilterDontDeleteWin(Type type)
	{
		if(dontDeleteTypes==null)
		{
			...
			dontDeleteTypes.Add( typeof(SCMainView) );
			dontDeleteTypes.Add( typeof(MainView) );
			dontDeleteTypes.Add( typeof(MinIconView) );
			dontDeleteTypes.Add ( typeof(WebBulletScreenView) );
			dontDeleteTypes.Add ( typeof(FileMaterialDiaLog) );
			dontDeleteTypes.Add ( typeof(SCLoginView) );
			dontDeleteTypes.Add ( typeof(CombBulletScreenDisplayer) );
		}
...
public enum SCUIMessageId
{
	...
	FaterialWindowOpen, //default open?..
	FaterialWindowClose, 
